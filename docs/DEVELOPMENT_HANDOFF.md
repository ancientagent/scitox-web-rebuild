...
7. `docs/LLM_PRODUCT_GUIDANCE_ASSISTANT_PLAN.md`
...
12. `docs/WEBFLOW_QA_CHECKLIST.md`
...
3. Define the customer guidance lobby and live backend-source-grounded product guidance assistant from `docs/CUSTOMER_GUIDANCE_LOBBY_DIRECTION.md` and `docs/LLM_PRODUCT_GUIDANCE_ASSISTANT_PLAN.md`.
