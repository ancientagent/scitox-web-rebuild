...
3. `docs/VENDOR_ROUTE_CONTEXT.md`
...
8. `docs/LLM_PRODUCT_GUIDANCE_ASSISTANT_PLAN.md`
9. `docs/AGENT_SERVICE_BUILD_PROMPTS.md`
10. `docs/PUBLIC_SITE_MESSAGING_RULES.md`
11. `docs/VENDOR_READY_SITEMAP.md`
12. `docs/PAGE_BY_PAGE_WIREFRAME_PLAN.md`
13. `docs/WEBFLOW_DEVELOPMENT_BACKLOG.md`
14. `docs/WEBFLOW_QA_CHECKLIST.md`
15. `docs/SHARED_CHAT_CONTEXT.md`
16. `docs/SOURCE_INDEX.md`
17. `docs/SHARED_CHAT_TRANSCRIPT_STRUCTURED.txt` when exact prior conversation wording is needed
18. `project_sources/external_pages_manifest.json` when checking which linked sources were archived successfully
