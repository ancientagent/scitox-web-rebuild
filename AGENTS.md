...
This repository is the private SciTOX website rebuild, vendor-readiness, and Webflow handoff workspace.
...
2. Read `docs/CONTINUE_HERE.md` before strategy, Webflow, vendor, or claim-sensitive work.
